...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Online Campus Course Portal(Faculty)</title>
  ...
  <body>
    ...
    <form class="" action="#" method="post">
      ...
      <label for="username">Username(Faculty)</label><br>
	  ...
	  <a href="facultylogin.php">Don't have an account?</a>
...
<?php
    ...
    if(isset($_REQUEST["submit"]))
    {
      ...
      $sql = mysqli_query($success, "SELECT * FROM facultyregistration WHERE username = '".$_POST['username']."' and password = '".$_POST['password']."'");
	  ...
	  header("Location: http://localhost/PHP/login-20190903T065319Z-001/login/facultyhome.php");
