                ...
                <div class="navbar-header" align = "right">
                    ...
                    <a class="navbar-brand" href="home.php"><span>Online Course Portal</span></a>
                        ...
                        <ul style="float: right; margin-right: 40px;" class="nav navbar-nav">
                          ...
                          <li><a href="main1.php">Courses</a></li>
                    ...
                    <ul class="user-menu">
                        <li class="dropdown pull-right">
                            ...
                            <ul style="position: fixed; right: 3  px; top: 40px;" class="dropdown-menu" role="menu">
                                ...
                                <li><a href="mycourses.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg>My courses</a></li>
                                <li><a href="signin.php" ><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg>Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
